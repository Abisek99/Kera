...
namespace HKCR.Infra.Migrations
{
    ...
    [Migration("20230502214324_dfhbs")]
    partial class dfhbs
    {
            ...
            modelBuilder.Entity("HKCR.Domain.Entities.AddUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "96428d91-ed38-47d8-9ec6-d7032de793fa",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMTSBhw3UaaDUzxzUoJl8oWmrL66VptbOeorWgPfGdkGMSpaV9S/ltPYsh3Dxqxn3Q==",
                            PhoneNumberConfirmed = false,
                            Profile = "/public/images/uploads/user.jpg",
                            RoleUser = "admin",
                            SecurityStamp = "3121e354-1fbb-4d05-b0b2-7a1b955db87e",
            ...
            modelBuilder.Entity("HKCR.Domain.Entities.DamageRequest", b =>
                {
                    ...
                    b.HasOne("HKCR.Domain.Entities.Rent", "Rent")
                        .WithMany("DamageRequests")
